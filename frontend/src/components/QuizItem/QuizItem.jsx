			...
			>
				...
				<div className="d-flex justify-content-between">
					...
					<p className="badge text-bg-primary text-wrap">
						Amount Of Completions: {amountOfCompletions}
					</p>
				</div>
			</div>
			{showActionsModal && (
				...
				>
					<Modal.Dialog>
						...
						<Modal.Body className="d-flex gap-4">
							...
							<Button variant="warning" onClick={handleShowRemoveAlertModal}>
								Remove
							</Button>
						</Modal.Body>
					</Modal.Dialog>
			...
			>
				...
				<Modal.Footer style={{ justifyContent: "space-between" }}>
					<div className="d-flex gap-3">
						<Button variant="warning" onClick={handleRemoveQuiz}>
							Yes
						</Button>
						<Button
							variant="secondary"
